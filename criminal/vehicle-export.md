...
You can steal high-value vehicles from NPCs or that are parked on the street, then **export them illegally** at the docks :export_vehicle: in **Elysian Island** for a good pay depending on which vehicle is sold.
...
You can then press <kbd>Y</kbd> / hold :UP: to get a GPS destination leading you to **the Docks** :export_vehicle:

Once you get there, drive the stolen vehicle into the export circle (red circle) and press <kbd>Y</kbd> / hold :UP: : doing so will make the vehicle vanish and give you money, depending on the state of the vehicle *(damage will lower the reward)*. 
...
missing_picture export_car.webp" alt="Vehicle Export: Exporting car at the docks:
...
You can check which vehicle is the **most wanted vehicle** at anytime by typing **<kbd>/mwveh</kbd>** in the chat.
...
missing_picture mwveh_green_arrow.webp" alt="Vehicle Export: Most Wanted vehicle green arrow:
...
- **Emergency players cannot see what the most wanted vehicle is**: They can't do the <kbd>/mwveh</kbd> command, and won't be notified of the mwveh every day at 5:00am. 
...
> [!TIP]
> For reference, here is a Community made google sheets with all the cars you can export with their value, most wanted vehicle value, areas you can find them in and other information about them: [**Vehicles export + scrap CNRV**](https://docs.google.com/spreadsheets/d/1_fqQtO_E_H-tc3Ldq5XH2zL_BA-vOVZ-NZOLLkUB5Mk)