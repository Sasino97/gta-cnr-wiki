...
<div style="display: flex; align-items: flex-start; gap: 10px;">
  ...
  #### Information
  Just a regular rifle, but stockless. Sacrifices accuracy for flexibility. 
  If you the ATF catches you with this, hide your dog.

  </div>

  <div style="width: 300px; border: 2px solid black; font-family: Arial, sans-serif; background-color: #f9f9f9; color: black;">
    <div style="background-color: #f9f9f9; padding: 10px; font-size: 20px; font-weight: bold; text-align: center;">Compact Rifle</div>
    <div style="text-align: center; padding: 10px;">
      <img src="image_url_here" alt="Compact Rifle" style="width: 100%; height: auto;">
    </div>
    <div style="padding: 10px;">
      ...
      <ul style="padding: 5px;">
        ...
        <li><strong>Attachments:</strong> Extended Mag, Drum Mag</li>
      </ul>
    </div>
  </div>
