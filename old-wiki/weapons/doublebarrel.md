# Weapon Guide - Double Barrel Shotgun
...
<div style="display: flex; align-items: flex-start; gap: 10px;">
  ...
  #### Information
  Classic break-action shotgun. Used before the world wars.
  Banned when the Army attacked maltreated veterans' peaceful protest to prevent assassinations.

  </div>

  <div style="width: 300px; border: 2px solid black; font-family: Arial, sans-serif; background-color: #f9f9f9; color: black;">
    <div style="background-color: #f9f9f9; padding: 10px; font-size: 20px; font-weight: bold; text-align: center;">Double Barrel Shotgun</div>
    <div style="text-align: center; padding: 10px;">
      <img src="image_url_here" alt="Double Barrel Shotgun" style="width: 100%; height: auto;">
    </div>
